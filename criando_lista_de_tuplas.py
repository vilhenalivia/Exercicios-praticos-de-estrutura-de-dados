...
#Lista vazia para locar as sublistas transformadas em tuplas
atletas_tupla = []

# Loop para converter cada sublista em tupla:
for atleta in atletas:
    nome = atleta[0]
    altura = atleta[1]
    peso = atleta[2]
    atleta_tupla = (nome, altura, peso)
    atletas_tupla.append(atleta_tupla)

#Impreção da lista de tuplas
print(atletas_tupla)
